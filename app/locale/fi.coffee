...
#    play_classroom_version: "Play Classroom Version" # Choose a level in campaign version that you also can play in one of your courses
    campaign_beginner: "Aloittelijan Kampanja"
...
#    campaign_old_multiplayer_description: "Relics of a more civilized age. No simulations are run for these older, hero-less multiplayer arenas."
  ...
  share_progress_modal:
    ...
    form_blurb: "Syötä heidän sähköpostiosoitteensa ja me kerromme heille!"
...
#    tip_mulan: "Believe you can, then you will. - Mulan"
  ...
  subscribe:
    ...
    parents: "Vanhemmille"
    parents_title: "Hyvät vanhemmat: lapsenne haluaa oppia ohjelmoimaan. Autatteko häntä oppimaan?"
    parents_blurb1: "Lapsenne on läpäissyt jo __nLevels__ tasoa ja oppinut niissä ohjelmoinnin alkeita. Auta häntä etenemmään tehokkaammin oppimisessaan ostamalla hänelle CodeCombatin kuukausitilaus."
    ...
    currently_free: "Sinulla on tällä hetkellä ilmainen tilaus"
